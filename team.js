...
client.on('ready', () => {
  client.user.setGame(` By MΛTЯIXᴴᴰ#0028 .`,'https://www.twitch.tv/TOS');
  console.log('---------------');
  console.log('Team One Shot System Is Online')
  console.log('---------------')
});
...
client.on('guildMemberAdd', member => {
  channel.send(`Welcome ${member} To Team One Shot`, { 
    file: 'https://image.ibb.co/dNGVKz/Screenshot_1.png' 
  });
  let embed = new Discord.RichEmbed()
    .setTitle("Welcome To Team One Shot")
